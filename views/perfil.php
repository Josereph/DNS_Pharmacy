            ...
            <div class="modal-body">
                ...
                <div class="form-row-custom">
                    ...
                    <div class="form-group-custom">
                        <label>Nombre *</label>
                        <input type="text" id="edit_nombre" placeholder="Nombre">
                        <span id="err_edit_nombre" class="form-error"></span>
                    </div>

                    <div class="form-group-custom">
                        <label>Apellido *</label>
                        <input type="text" id="edit_apellido" placeholder="Apellido">
                        <span id="err_edit_apellido" class="form-error"></span>                        
                    </div>
                ...
                <div class="form-row-custom">
                    ...
                    <div class="form-group-custom">
                        <label>Correo</label>
                        <input type="email" id="edit_correo" placeholder="Correo" class="form-input" readonly>
<span id="err_edit_correo" ></span>

                    </div>

                    <div class="form-group-custom">
                        <label>Teléfono</label>
                        <input type="text" id="edit_telefono" placeholder="Teléfono" class="form-input">
                        <span id="err_edit_telefono" class="form-error"></span>
                    </div>
        ...
        <form id="formPassword" novalidate>
            ...
            <div class="modal-body">
                ...
                <div class="form-group-custom">
                  ...
                  <input type="password" id="pass_actual" placeholder="Actual">
                  <span id="err_pass_actual" class="form-error"></span>
                </div>

                <div class="form-group-custom">
                    <label>Nueva contraseña *</label>
                   <input type="password" id="pass_nueva" placeholder="Nueva">
                    <span id="err_pass_nueva" class="form-error"></span>
                </div>

                <div class="form-group-custom">
                    <label>Confirmar *</label>
                    <input type="password" id="pass_confirmar" placeholder="Confirmar">
                    <span id="err_pass_confirmar" class="form-error"></span>
                </div>
