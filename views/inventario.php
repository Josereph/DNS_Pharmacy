...
<div class="main-content">
    ...
    <div id="tabStock" class="tab-content active-tab animate__animated animate__fadeIn">
        <div class="tab-header">
            ...
            <button class="btn-nueva-compra" type="button" onclick="abrirModalCompra()">
        ...
        <div class="tabla-card">
            ...
            <table class="tabla-inv">
                ...
                <tbody id="cuerpoStock">
                    <tr>
                        <td colspan="9" class="tabla-vacia">Cargando...</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="tabla-card">
            ...
            <table class="tabla-inv">
                ...
                <tbody id="cuerpoCompras">
                    <tr>
                        <td colspan="10" class="tabla-vacia">Cargando...</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div class="modal-overlay" id="modalCompra">
    <div class="modal-box modal-xl animate__animated animate__slideInUp animate__faster">
        <div class="modal-header">
            ...
            <button type="button" class="modal-cerrar" onclick="cerrarModal('modalCompra')">&times;</button>
        </div>
            ...
            <div class="modal-body">
                ...
                <div class="compra-totales">
                    <div class="compra-total-row">
                        <span>Subtotal</span>
                        <span id="compSubtotal">$0.00</span>
                    </div>
                    <div class="compra-total-row iva-row" id="ivaRowCompra">
                        <span>IVA (13%)</span>
                        <span id="compIva">$0.00</span>
                    </div>
                    <div class="compra-total-row compra-total-final">
                        <span>Total</span>
                        <span id="compTotal">$0.00</span>
                    </div>
                </div>
            </div>
...
<div class="modal-overlay" id="modalDetalle">
    <div class="modal-box modal-mediano animate__animated animate__zoomIn animate__faster">
        <div class="modal-header">
            <h5 class="modal-titulo">
                <i class="bi bi-file-earmark-text"></i> Detalle de compra
            </h5>
            <button type="button" class="modal-cerrar" onclick="cerrarModal('modalDetalle')">&times;</button>
        </div>
