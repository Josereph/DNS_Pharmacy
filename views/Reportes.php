...
<div class="main-content">
    ...
    <div class="rep-header">
        <div class="rep-header-left">
            ...
            <p class="rep-subtitle">Estadísticas y análisis del negocio</p>
        </div>
    ...
    <div class="kpi-grid" id="kpiGrid">
        ...
        <div class="kpi-card kpi-orange">
            ...
            <div class="kpi-body">
                <div class="kpi-val" id="kpiTicket">—</div>
    ...
    <div id="tabVentas" class="rep-tab-content active-tab">
        <div class="charts-grid-2">
            ...
            <div class="chart-card chart-wide">
                ...
                <div class="chart-wrap"><canvas id="chartVentasTiempo"></canvas></div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap chart-wrap-donut"><canvas id="chartMetodoPago"></canvas></div>
        ...
        <div class="rep-table-card">
            <div class="rep-table-header">
                ...
                <input type="text" id="buscadorVentas" class="rep-search" placeholder="Buscar ticket..." oninput="filtrarTablaVentas()">
            </div>
            <table class="rep-table" id="tablaVentas">
                ...
                <tbody id="cuerpoTablaVentas">
                    <tr><td colspan="9" class="tabla-vacia"><i class="bi bi-arrow-repeat spin"></i> Cargando...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
    ...
    <div id="tabInventario" class="rep-tab-content">
        <div class="charts-grid-3">
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap chart-wrap-donut"><canvas id="chartEstadoStock"></canvas></div>
            ...
            <div class="chart-card chart-wide-2">
                ...
                <div class="chart-wrap"><canvas id="chartStockCategoria"></canvas></div>
            </div>
        </div>
        ...
        <div class="charts-grid-2">
            ...
            <div class="chart-card chart-wide">
                ...
                <div class="chart-wrap"><canvas id="chartMovimientos"></canvas></div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap"><canvas id="chartInversionCategoria"></canvas></div>
            </div>
        </div>
        ...
        <div class="rep-table-card rep-alerta-table">
            ...
            <table class="rep-table" id="tablaStockBajo">
                ...
                <tbody id="cuerpoTablaStockBajo">
                    <tr><td colspan="7" class="tabla-vacia"><i class="bi bi-arrow-repeat spin"></i> Cargando...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
    ...
    <div id="tabEmpleados" class="rep-tab-content">
        <div class="charts-grid-2">
            ...
            <div class="chart-card chart-wide">
                ...
                <div class="chart-wrap"><canvas id="chartVentasEmpleado"></canvas></div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap chart-wrap-donut"><canvas id="chartTicketsEmpleado"></canvas></div>
        ...
        <div class="charts-grid-2">
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap"><canvas id="chartTurnos"></canvas></div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap"><canvas id="chartTicketPromEmpleado"></canvas></div>
            </div>
        </div>
        ...
        <div class="rep-table-card">
            ...
            <table class="rep-table" id="tablaEmpleados">
                ...
                <tbody id="cuerpoTablaEmpleados">
                    <tr><td colspan="8" class="tabla-vacia"><i class="bi bi-arrow-repeat spin"></i> Cargando...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
    ...
    <div id="tabProveedores" class="rep-tab-content">
        <div class="charts-grid-2">
            ...
            <div class="chart-card chart-wide">
                ...
                <div class="chart-wrap"><canvas id="chartComprasProveedor"></canvas></div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap chart-wrap-donut"><canvas id="chartParticipacionProveedor"></canvas></div>
        ...
        <div class="charts-grid-2">
            ...
            <div class="chart-card chart-wide">
                <div class="chart-card-header">
                    <span class="chart-title"><i class="bi bi-calendar3"></i> Evolución de compras en el período</span>
                </div>
                <div class="chart-wrap"><canvas id="chartComprasTiempo"></canvas></div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap"><canvas id="chartTopReabastecidos"></canvas></div>
            </div>
        </div>
        ...
        <div class="rep-table-card">
            <div class="rep-table-header">
                ...
                <input type="text" id="buscadorCompras" class="rep-search" placeholder="Buscar proveedor..." oninput="filtrarTablaCompras()">
            </div>
    ...
    <div id="tabProductos" class="rep-tab-content">
        <div class="charts-grid-2">
            ...
            <div class="chart-card chart-wide">
                ...
                <div class="chart-wrap"><canvas id="chartTopVendidos"></canvas></div>
            </div>
            <!-- Margen por categoría -->
            <div class="chart-card">
                <div class="chart-card-header">
                    <span class="chart-title"><i class="bi bi-percent"></i> Margen de ganancia por categoría</span>
                </div>
        ...
        <div class="charts-grid-2">
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrap chart-wrap-donut"><canvas id="chartSinMovimiento"></canvas></div>
                <div class="chart-legend" id="legendSinMovimiento"></div>
            </div>
            <!-- Rentabilidad por producto -->
            <div class="chart-card">
                <div class="chart-card-header">
                    <span class="chart-title"><i class="bi bi-currency-dollar"></i> Ingresos por categoría vs costo</span>
                </div>
                <div class="chart-wrap"><canvas id="chartRentabilidad"></canvas></div>
            </div>
        </div>
        ...
        <div class="rep-table-card">
            <div class="rep-table-header">
                ...
                <input type="text" id="buscadorProductos" class="rep-search" placeholder="Buscar producto..." oninput="filtrarTablaProductos()">
            </div>
